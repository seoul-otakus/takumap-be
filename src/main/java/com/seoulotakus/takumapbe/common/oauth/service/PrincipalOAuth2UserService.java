package com.seoulotakus.takumapbe.common.oauth.service;
...
import com.seoulotakus.takumapbe.common.oauth.dto.OAuthAttributes;
...
public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException{
    ...
    private UserEntity saveOrUpdate(OAuthAttributes attributes){
        ...
        // userId 생성 로직 추가 -> ex) kakao_023459
        if(user.getUserId() == null){
            user.setUserId(attributes.getProvider().name().toLowerCase() + "_" + attributes.getProviderId().substring(0,6));
        }
